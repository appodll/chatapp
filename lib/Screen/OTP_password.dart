...
class OTP_password extends StatelessWidget {
  final email;
  OTP_password({super.key, @required this.email});
            ...
            children: [
              ...
              Row(
                ...
                TextButton(onPressed: (){
                  _auth.forgot_password_resendOTP(email, context);
              ...
              ElevatedButton(onPressed: (){
                _auth.password_verify_OTP(otp.value.text, email, context);
